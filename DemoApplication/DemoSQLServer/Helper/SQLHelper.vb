...
#Region "CreateCommand"
    ...
    'Homer, added this to dynamically get the parameter names in the order they appear in the Stored Procedure
    Public Shared Function GetParamNames(ByVal connection As SqlConnection, ByVal spName As String) As String()
        Dim names As New ArrayList
        For Each param As SqlParameter In SqlHelperParameterCache.GetSpParameterSet(connection, spName)
